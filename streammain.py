...
with testing:
    ...
    imp_a = col1.text_input("Enter Delivery for Control Group",'379990')
    imp_b = col1.text_input("Enter Delivery for Test Group",'652515')
    conv_a = col2.text_input('Enter KPI Results for Control Group','102')
    conv_b = col2.text_input('Enter KPI Results for Test Group','228')
